...
local function applySkillsOverlayLayout()
    if not skillsWindow then
        return
    end

    skillsWindow:setVisible(true)
    skillsWindow:setDraggable(false)
    skillsWindow:setBackgroundColor('#121722cc')
    skillsWindow:setBorderWidth(1)
    skillsWindow:setBorderColor('#5b8cff44')
end
...
function online()
    ...
    hideOldClientStats()
    updateHeight()
    addEvent(applySkillsOverlayLayout)
end
