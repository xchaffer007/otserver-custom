...
function ActionBarController:onGameStart()
    ApiJson.setBarVisibility(1, 'actionBarShowBottom1', true, true)
    ApiJson.setBarVisibility(2, 'actionBarShowBottom2', true, true)
    ApiJson.setBarVisibility(3, 'actionBarShowBottom3', false, true)
    onCreateActionBars()
    ...
    local primaryBar = actionBars[1]
    if primaryBar then
        primaryBar:setWidth(328)
        primaryBar:show()
        primaryBar:setVisible(true)
        primaryBar:setOn(true)
    end

    local secondaryBar = actionBars[2]
    if secondaryBar then
        secondaryBar:setWidth(184)
        secondaryBar:show()
        secondaryBar:setVisible(true)
        secondaryBar:setOn(true)
    end

    local thirdBar = actionBars[3]
    if thirdBar then
        thirdBar:hide()
        thirdBar:setOn(false)
    end
